  ...
  [2],
  {
            ...
            [
              ...
              function (t, r) {
                ...
                for (var _ = 0, x = 0, C = []; x < p.length; ) {
                  ...
                  if (
                    null === y ||
                    ($ = d(l(b.lastIndex + (g ? 0 : x)), p.length)) === _
                  )
                    x = u(p, x, v);
                  else {
    ...
    333: function (t, e, n) {
      ...
      var i = n(309),
        r = {
          name: "SidebarGroup",
          components: { DropdownTransition: n(334).a },
          props: ["item", "open", "collapsable", "depth"],
          beforeCreate: function () {
            this.$options.components.SidebarLinks = n(333).default;
          },
    ...
    335: function (t, e, n) {
      ...
      var i = n(0),
        r = n(336);
      i(
        { target: "String", proto: !0, forced: n(337)("link") },
        {
          link: function (t) {
    ...
    361: function (t, e, n) {
      ...
      var R = N,
        ...
        H = {
          name: "Sidebar",
          components: { SidebarLinks: n(333).default, NavLinks: C },
          props: ["items"],
        },
        W =
          (n(357),
